...
export const DELETE_FROM_WISH_REQUEST = "DELETE_FROM_WISH_REQUEST";
export const DELETE_FROM_WISH_SUCCESS = "DELETE_FROM_WISH_SUCCESS";
export const DELETE_FROM_WISH_ERROR = "DELETE_FROM_WISH_ERROR";
